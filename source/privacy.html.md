...
i) that need to know that information in order to process it on DataCite’s behalf or to provide services available at DataCite’s websites, and
...
If the processing of your personal data is based on Art. 6 No. 1 lit. e or f GDPR, you have the right to object to the processing if the further requirements of Art. 21 GDPR are met.
You can require this by sending us an email at: info@datacite.org  
